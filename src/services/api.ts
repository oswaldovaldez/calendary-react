...
export const Api = {
  ...
  deleteUser:(data:{user_id:number,_token: string})=>apiFetch(`/users/${data.user_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteCategory:(data:{category_id:number,_token: string})=>apiFetch(`/categories/${data.category_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteService:(data:{service_id:number,_token: string})=>apiFetch(`/services/${data.service_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteProduct:(data:{product_id:number,_token: string})=>apiFetch(`/products/${data.product_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deletePatient:(data:{patient_id:number,_token: string})=>apiFetch(`/patients/${data.patient_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteRecordTemplate:(data:{recordTemplate_id:number,_token: string})=>apiFetch(`/record-templates/${data.recordTemplate_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteRecord:(data:{record_id:number,_token: string})=>apiFetch(`/records/${data.record_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteSchedule:(data:{schedule_id:number,_token: string})=>apiFetch(`/schedules/${data.schedule_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
  ...
  deleteAppointment:(data:{appointment_id:number,_token: string})=>apiFetch(`/appointments/${data.appointment_id}`,{method:'PATCH',body:data,headers: {Authorization:`Bearer ${data._token}`}}),
