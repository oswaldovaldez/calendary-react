...
interface FormProductProps {
  ...
  onSubmit: (
    values: ProductType,
    helpers: FormikHelpers<ProductType>
  ) => void | Promise<void>;
}
        ...
        <Form className="form-container">
          <div className="card neumo">
            <div className="card-body grid gap-4 md:grid-cols-2">
              ...
              <div className="form-group">
                <label htmlFor="price_with_discount" className="form-label">
                  Precio con descuento
                </label>
                <Field
                  className="input input-sm"
              ...
              <div className="form-group">
                ...
                <Field
                  ...
                  placeholder="0.00"
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setFieldValue("commission", parseFloat(e.target.value))
                  }
                />
                <ErrorMessage
                  name="commission"
              ...
              <div className="form-group">
                ...
                <Field
                  ...
                  placeholder="16"
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setFieldValue("iva", parseFloat(e.target.value))
                  }
                />
                <ErrorMessage
                  name="iva"
              ...
              {/* Stock alert */}
              <div className="form-group">
                <label htmlFor="stock_alert" className="form-label">
                  Alerta de stock
                </label>
                <Field
                  className="input input-sm"
                  ...
                  placeholder="0"
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setFieldValue("stock_alert", parseInt(e.target.value, 10))
                  }
                />
                <ErrorMessage
                  name="stock_alert"
              ...
              <div className="form-group">
                <label className="form-label">
                  <Field type="checkbox" name="status" className="mr-2" />
                  Status
                </label>
              </div>
