          ...
          <button
            onClick={() =>
              showConfirm({
                ...
                message: `¿Deseas eliminar el servicio <strong>${info.row.original.name}</strong>?`,
                successText: `El servicio <strong>${info.row.original.name}</strong> se eliminó correctamente.`,
                errorText: `No se pudo eliminar el servicio <strong>${info.row.original.name}</strong>. Intenta de nuevo.`,
              })
            }
